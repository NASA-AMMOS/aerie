...
public record GenerateConstraintsLibAction(
    TypescriptCodeGenerationServiceAdapter typescriptCodeGenerationService) {
  ...
  public Response run(final String missionModelId, final Optional<PlanId> planId) {
    ...
    try {
      ...
      final var constraintsApi =
          Files.readString(
              Paths.get(
                  constraintsDslCompilerRoot, "src", "libs", "constraints-edsl-fluent-api.ts"));
      final var constraintsAst =
          Files.readString(
              Paths.get(constraintsDslCompilerRoot, "src", "libs", "constraints-ast.ts"));
      final var temporalPolyfillTypes =
          Files.readString(
              Paths.get(constraintsDslCompilerRoot, "src", "libs", "TemporalPolyfillTypes.ts"));
      final var generated =
          typescriptCodeGenerationService.generateTypescriptTypes(missionModelId, planId);
      return new Response.Success(
          Map.of(
              "constraints-edsl-fluent-api.ts", constraintsApi,
