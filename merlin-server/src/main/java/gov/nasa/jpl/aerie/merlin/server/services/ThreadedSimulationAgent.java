...
public final class ThreadedSimulationAgent implements SimulationAgent {
  private /*sealed*/ interface SimulationRequest {
    record Simulate(PlanId planId, RevisionData revisionData, ResultsProtocol.WriterRole writer)
        implements SimulationRequest {}
  ...
  public static ThreadedSimulationAgent spawn(
      final String threadName, final SimulationAgent simulationAgent) {
  ...
  public void simulate(
      final PlanId planId, final RevisionData revisionData, final ResultsProtocol.WriterRole writer)
  ...
  private record Worker(
      BlockingQueue<SimulationRequest> requestQueue, SimulationAgent simulationAgent)
      implements Runnable {
    private Worker(
