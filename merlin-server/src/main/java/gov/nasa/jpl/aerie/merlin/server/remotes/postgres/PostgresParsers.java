...
public final class PostgresParsers {
  ...
  public static final JsonParser<Timestamp> pgTimestampP =
      new JsonParser<>() {
        ...
        public JsonObject getSchema(final SchemaCache anchors) {
          return Json.createObjectBuilder(stringP.getSchema()).add("format", "date-time").build();
        }
  ...
  static final JsonParser<Pair<String, ValueSchema>> profileTypeP =
      chooseP(discreteProfileTypeP, realProfileTypeP);

  public static Duration parseOffset(
      final ResultSet resultSet, final int index, final Timestamp epoch) throws SQLException {
  ...
  public static Duration parseOffset(
      final ResultSet resultSet, final int index, final Instant epoch) throws SQLException {
  ...
  public static final JsonParser<Map<String, SerializedValue>> activityArgumentsP =
      mapP(serializedValueP);

  public static final JsonParser<Map<String, SerializedValue>> simulationArgumentsP =
      mapP(serializedValueP);

  public static final JsonParser<ActivityAttributesRecord> activityAttributesP =
      productP
  ...
  public static final JsonParser<Map<String, Pair<Integer, ValueSchema>>> parameterRecordP =
      mapP(productP.field("order", intP).field("schema", valueSchemaP));

  public static <V> JsonParseResult<V> getJsonColumn(
      final ResultSet results, final String column, final JsonParser<V> parser)
      throws SQLException {
