...
/*package-local*/ final class CreatePlanDatasetAction implements AutoCloseable {
  private final @Language("SQL") String sql = """
      insert into plan_dataset (plan_id, offset_from_plan_start, dataset_duration)
  ...
  public PlanDatasetRecord apply(
    ...
    PreparedStatements.setTimestamp(this.statement, 4, datasetEnd);
    PreparedStatements.setTimestamp(this.statement, 5, planStart);
