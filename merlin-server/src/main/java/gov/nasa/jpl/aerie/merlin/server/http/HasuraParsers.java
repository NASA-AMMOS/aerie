...
public abstract class HasuraParsers {
  ...
  private static <I extends HasuraAction.Input> JsonParser<HasuraAction<I>> hasuraActionF(
    ...
    return productP
        ...
        .map(
            untuple(
                (name, input, session, requestQuery) -> new HasuraAction<>(name, input, session)),
            $ -> tuple($.name(), $.input(), $.session(), ""));
  }

  public static final JsonParser<HasuraAction<HasuraAction.MissionModelInput>>
      hasuraMissionModelActionP =
          hasuraActionF(
              productP
                  .field("missionModelId", stringP)
                  .map(
                      HasuraAction.MissionModelInput::new,
                      HasuraAction.MissionModelInput::missionModelId));
  ...
  public static final JsonParser<HasuraAction<HasuraAction.ConstraintsInput>>
      hasuraConstraintsCodeAction =
          hasuraActionF(
              productP
                  .field("missionModelId", stringP)
                  ...
                  .map(
                      untuple(
                          (modelId, planId) ->
                              new HasuraAction.ConstraintsInput(modelId, planId.flatMap($ -> $))),
  ...
  public static final JsonParser<HasuraMissionModelEvent> hasuraMissionModelEventTriggerP =
      productP
          .field(
              "event",
              productP
                  .field("data", productP.field("new", productP.field("id", longP).rest()).rest())
                  .rest())
          .rest()
          .map(
              untuple(
                  missionModelId -> new HasuraMissionModelEvent(String.valueOf(missionModelId))),
              $ -> tuple(Long.parseLong($.missionModelId())));

  public static final JsonParser<HasuraActivityDirectiveEvent>
      hasuraActivityDirectiveEventTriggerP =
          productP
              .field(
                  "event",
                  productP
              ...
              .map(
                  untuple(
                      (planId, activityDirectiveId, type, arguments, argumentsModifiedTime) ->
                          new HasuraActivityDirectiveEvent(
                              new PlanId(planId),
                              new ActivityDirectiveId(activityDirectiveId),
                              type,
                              arguments,
                              argumentsModifiedTime)),
                  $ ->
                      tuple(
                          $.planId().id(),
  ...
  private static final JsonParser<HasuraAction.MissionModelArgumentsInput>
      hasuraMissionModelArgumentsInputP =
          productP
              .field("missionModelId", stringP)
  ...
  public static final JsonParser<HasuraAction<HasuraAction.MissionModelArgumentsInput>>
      hasuraMissionModelArgumentsActionP = hasuraActionF(hasuraMissionModelArgumentsInputP);
  ...
  public static final JsonParser<HasuraAction<HasuraAction.UploadExternalDatasetInput>>
      hasuraUploadExternalDatasetActionP =
          hasuraActionF(
              productP
                  .field("planId", planIdP)
  ...
  public static final JsonParser<HasuraAction<HasuraAction.ExtendExternalDatasetInput>>
      hasuraExtendExternalDatasetActionP =
          hasuraActionF(
              productP
