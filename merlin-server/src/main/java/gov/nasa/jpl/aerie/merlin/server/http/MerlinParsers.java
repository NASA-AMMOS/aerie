...
public abstract class MerlinParsers {
  ...
  public static final JsonParser<ActivityDirectiveId> activityDirectiveIdP =
      longP.map(ActivityDirectiveId::new, ActivityDirectiveId::id);

  public static final JsonParser<PlanId> planIdP = longP.map(PlanId::new, PlanId::id);

  public static final JsonParser<DatasetId> datasetIdP = longP.map(DatasetId::new, DatasetId::id);

  public static final JsonParser<SimulationFailure> simulationFailureP =
      productP
          .field("type", stringP)
