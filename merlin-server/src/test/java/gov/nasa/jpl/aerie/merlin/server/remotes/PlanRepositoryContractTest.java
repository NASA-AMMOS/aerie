...
public abstract class PlanRepositoryContractTest {
  ...
  public void testCreatePlanWithActivity() throws NoSuchPlanException {
    ...
    // WHEN
    final ActivityDirective activity =
        new ActivityDirective(
            Duration.ZERO, "abc", Map.of("abc", SerializedValue.of(1)), null, true);
  ...
  public void testCreatePlanWithNullActivitiesList() throws NoSuchPlanException {
    ...
    // THEN
    assertThat(this.planRepository.getPlanForValidation(ids.planId()).activityDirectives)
        .isNotNull()
        .isEmpty();
  }
