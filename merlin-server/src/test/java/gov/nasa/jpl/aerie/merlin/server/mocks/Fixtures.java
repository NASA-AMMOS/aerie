...
public final class Fixtures {
  ...
  public final StubMissionModelService adaptationService;
  ...
  public Fixtures() {
    try {
      ...
      this.adaptationService = new StubMissionModelService();
      ...
      this.NONEXISTENT_ADAPTATION_ID = StubMissionModelService.NONEXISTENT_ADAPTATION_ID;
      this.EXISTENT_ADAPTATION_ID = StubMissionModelService.EXISTENT_ADAPTATION_ID;
