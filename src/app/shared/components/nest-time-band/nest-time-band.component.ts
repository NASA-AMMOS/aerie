...
@Component({
  selector: 'nest-time-band',
  styleUrls: ['./nest-time-band.component.css'],
  templateUrl: './nest-time-band.component.html',
})
export class NestTimeBandComponent implements AfterViewInit, OnChanges {
  @Input()
  height = 50;
