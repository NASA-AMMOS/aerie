 ...
 */
export const getDefaultBandSettings = createSelector(getConfigState, (config: ConfigState) => config.defaultBandSettings);
export const getItarMessage = createSelector(getConfigState, (config: ConfigState) => config.itarMessage);
export const getUrls = createSelector(getConfigState, (config: ConfigState) => ({ baseUrl: config.baseUrl, epochsUrl: config.epochsUrl }));
export const getVersion = createSelector(getConfigState, (config: ConfigState) => config.version);
