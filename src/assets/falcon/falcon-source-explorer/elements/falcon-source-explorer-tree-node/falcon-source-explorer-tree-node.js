...
(function (window) {
  ...
  class FalconSourceExplorerTreeNode extends GenericTree(Polymer.mixinBehaviors([FalconPolymerUtils, FalconSourceExplorerUtils], Polymer.Element)) {
     ...
     */
    getChildren() {
      return Polymer.dom(this).querySelectorAll('falcon-source-explorer-tree-node');
    }
    ...
    _onDragStart(e) {
      if (!dragHelper.dragging) {
        ...
        const dragImage = Polymer.dom(this).querySelector('falcon-source-explorer-tree-node > div > div > div > span:nth-child(1)');
