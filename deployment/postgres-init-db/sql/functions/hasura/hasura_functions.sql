...
create table hasura.resource_at_start_offset_return_value(
...
create function hasura.get_resources_at_start_offset(_dataset_id int, _start_offset interval)
...
create function hasura.restore_activity_changelog(
  _plan_id integer,
