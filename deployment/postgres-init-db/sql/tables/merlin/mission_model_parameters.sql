create table merlin.mission_model_parameters (
...
comment on table merlin.mission_model_parameters is e''
  'The model parameters extracted from a mission model.';

comment on column merlin.mission_model_parameters.model_id is e''
  'The model these parameters are extracted from.';
comment on column merlin.mission_model_parameters.revision is e''
  'The revision of the model these parameters are extracted from.';
comment on column merlin.mission_model_parameters.parameters is e''
