...
comment on table merlin.activity_directive_validations is e''
  'The activity validations extracted from an activity directive.';

comment on column merlin.activity_directive_validations.directive_id is e''
  'The activity directive these validations are extracted from.';
comment on column merlin.activity_directive_validations.plan_id is ''
  'The plan associated with the activity directive these validations are extracted from.';
comment on column merlin.activity_directive_validations.last_modified_arguments_at is e''
  'The time at which these argument validations were last modified.';
comment on column merlin.activity_directive_validations.validations is e''
