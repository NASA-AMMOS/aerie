...
*/
begin;
  -- Revoke Migrated Postgres permissions
  revoke all privileges on schema merlin from :"postgres_user";
  revoke all privileges on schema scheduler from :"postgres_user";
  revoke all privileges on schema sequencing from :"postgres_user";
  revoke all privileges on schema ui from :"postgres_user";

  -- Revoke Migrated Aerie permissions
  revoke all privileges on schema ui from :"aerie_user";
  ...
  -- CLEANUP --
  -------------
  -- Revoke Migrated Public permissions
  revoke create on schema merlin from public;
  revoke all privileges on schema scheduler from public;
  revoke all privileges on schema sequencing from public;
  revoke all privileges on schema ui from public;

  -- Restore public schema can be used
