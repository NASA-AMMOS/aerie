...
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|-----------|---------------------------------|
| `AERIE_DB_HOST`                       | The DB instance that Merlin will connect with                                                                               | `string`  |                                 |
...
| `MERLIN_DB_USER`                      | Username of the Merlin DB User                                                                                              | `string`  |                                 |
...
|------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|----------|----------------------------------------------|
| `AERIE_DB_HOST`                          | The DB instance that Merlin will connect with                                                                               | `string` |                                              |
| `AERIE_DB_PORT`                          | The DB instance port number that Merlin will connect with                                                                   | `number` |                                              |
| `JAVA_OPTS`                              | Configuration for Merlin's logging level and output file                                                                    | `string` | log level: warn. output: stderr              |
| `MERLIN_WORKER_LOCAL_STORE`              | The local storage as for the Merlin container                                                                               | `string` | /usr/src/app/merlin_file_store               |
| `MERLIN_DB_USER`                         | Username of the Merlin DB User                                                                                              | `string` | (this must the same as the Merlin container) |
...
| Name                          | Description                                                     | Type     | Default                         |
|-------------------------------|-----------------------------------------------------------------|----------|---------------------------------|
| `AERIE_DB_HOST`               | The DB instance that scheduler will connect with                | `string` |                                 |
| `AERIE_DB_PORT`               | The DB instance port number that scheduler will connect with    | `number` | 5432                            |
...
| Name                          | Description                                                   | Type     | Default                            |
|-------------------------------|---------------------------------------------------------------|----------|------------------------------------|
| `AERIE_DB_HOST`               | Hostname of Postgres instance                                 | `string` |                                    |
