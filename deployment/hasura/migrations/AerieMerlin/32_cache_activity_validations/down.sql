-- restore (unused?) activity_directive_valdiation table
drop view activity_directive_validations;
...
drop trigger notify_validation_workers_trigger on activity_directive_changelog;
drop function notify_validation_workers;
