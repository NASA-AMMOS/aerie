...
public final class MerlinTestContext<Model> {
  ...
  public void use(final Model model, final Map<String, TaskSpecType<Model, ?>> activityTypes) {
    this.model = model;
  ...
  public Map<String, TaskSpecType<Model, ?>> activityTypes() { return activityTypes; }
}
