...
public class ActivityInstance {
  ...
  /**
   * Returns true if activity has been generated by another activity during simulation, false otherwise
   */
  public boolean isGenerated(){
    return topParent != null;
  }

  /**
   * Returns the id of parent activity
   */
  public SchedulingActivityInstanceId getParentActivity(){
    return topParent;
  }
