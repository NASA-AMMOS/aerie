...
public class CardinalityGoal extends ActivityTemplateGoal {
    ...
    *  */
    ...
    public static class Builder extends ActivityTemplateGoal.Builder<Builder> {
        ...
        public Builder inPeriod( TimeRangeExpression expr ) { inPeriod = expr; return getThis(); }
        protected TimeRangeExpression inPeriod;

        Range<Duration> durationRange;
        Range<Integer> occurrenceRange;

        public Builder duration(Range<Duration> durationRange) { this.durationRange = durationRange; return getThis();}
       public Builder occurences(Range<Integer> occurrenceRange){ this.occurrenceRange = occurrenceRange; return getThis(); }

        /**
         * {@inheritDoc}
         */
        @Override public CardinalityGoal build() { return fill( new CardinalityGoal() ); }
        ...
        protected CardinalityGoal fill(CardinalityGoal goal ) {
            ...
            if( inPeriod == null ) { throw new IllegalArgumentException(
    ...
    public Collection<Conflict> getConflicts( Plan plan ) {
        ...
        ActivityCreationTemplate actTB = new ActivityCreationTemplate.Builder().basedOn(this.desiredActTemplate).startsOrEndsIn(range).build();
    ...
    public  Collection<Conflict> getConflictsDurAndOccur(Plan plan, Duration durToSchedule, int nbToSchedule ){
        ...
        var possibleByJustExtending = (maxDurActs.minus(actPossibleDurations.getMinimum()).times(nbToSchedule)).compareTo(durToSchedule.minus(scheduledDur)) >= 0;
