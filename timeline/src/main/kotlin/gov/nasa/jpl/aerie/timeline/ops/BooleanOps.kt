 ...
 *
 * Currently only used by [gov.nasa.jpl.aerie.timeline.collections.profiles.Booleans], but could be used for
...
interface BooleanOps<THIS: BooleanOps<THIS>>: ConstantOps<Boolean, THIS> {
  ...
  /** [(DOC)][isolateTrue] Creates an [Intervals] objects with intervals whenever this profile is `true`. */
