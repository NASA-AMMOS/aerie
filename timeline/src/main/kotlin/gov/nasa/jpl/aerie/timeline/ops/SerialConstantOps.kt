 ...
 */
interface SerialConstantOps<V: Any, THIS: SerialConstantOps<V, THIS>>: SerialOps<V, THIS>, ConstantOps<V, THIS> {
  ...
  infix fun <OTHER: SerialConstantOps<V, OTHER>> equalTo(other: OTHER) =
      map2Values(::Booleans, other, BinaryOperation.combineOrNull { l, r, _ -> l == r })
   ...
   * two specific values.
   */
  fun transitions(from: V, to: V) = detectEdges(BinaryOperation.cases(
