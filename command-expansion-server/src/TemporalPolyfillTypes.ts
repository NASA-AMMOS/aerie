declare global {
  namespace Temporal {
    ...
    export type ZonedDateTimeToStringOptions = Partial<CalendarTypeToStringOptions & {
      timeZoneName?: 'auto' | 'never';
      offset?: 'auto' | 'never';
    }>;

    export type InstantToStringOptions = Partial<ToStringPrecisionOptions & {
    ...
    export class PlainDateTime {
      ...
      until(
          ...
          options?: DifferenceOptions<'year' | 'month' | 'week' | 'day' | 'hour' | 'minute' | 'second' | 'millisecond' | 'microsecond' | 'nanosecond'>
      ): Temporal.Duration;
    ...
    export class ZonedDateTime {
      ...
      until(
          ...
          options?: Temporal.DifferenceOptions<'year' | 'month' | 'week' | 'day' | 'hour' | 'minute' | 'second' | 'millisecond' | 'microsecond' | 'nanosecond'>
      ): Temporal.Duration;
