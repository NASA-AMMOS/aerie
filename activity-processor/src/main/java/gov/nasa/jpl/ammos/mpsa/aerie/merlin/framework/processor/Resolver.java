...
public final class Resolver {
  ...
  private CodeBlock getMapperFor(final TypeMirror mirror) {
    ...
    switch (mirror.getKind()) {
      // Primitives.
      case BOOLEAN:
        handler = gov.nasa.jpl.ammos.mpsa.aerie.merlin.framework.PrimitiveValueMappers.class;
        method = "$boolean";
        args = List.of();
        break;
      case BYTE:
      ...
      case ARRAY: {
        ...
        switch (t.getKind()) {
          case BOOLEAN:
            handler = gov.nasa.jpl.ammos.mpsa.aerie.merlin.framework.PrimitiveArrayValueMappers.class;
            method = "booleanArray";
            args = List.of();
            break;
          case BYTE:
