...
public final class Windows implements Iterable<Window> {
  ...
  public static class WindowAlgebra implements IntervalAlgebra<WindowAlgebra, Window> {
    ...
    public WindowAlgebra(Window horizon) { //in case users want a horizon from 0 to whenever, or 0 to infinity, or something. this will be coded into Windows as 0 to horizon end.
      horizon = horizon;
    }
    ...
    @Override
    public final Window bottom() {
      return Window.between(horizon.start, Window.Inclusivity.Exclusive, horizon.start, Window.Inclusivity.Exclusive);
    }
  }
}
