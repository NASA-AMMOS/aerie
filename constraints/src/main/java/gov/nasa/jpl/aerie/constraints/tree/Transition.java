...
public final class Transition implements Expression<Windows> {
  ...
  public Transition(
      final Expression<DiscreteProfile> profile,
      final SerializedValue oldState,
      final SerializedValue newState) {
  ...
  public String prettyPrint(final String prefix) {
    return String.format(
        "\n%s(transition %s\n%s  %s\n%s  %s)",
        prefix, this.profile.prettyPrint(prefix + "  "), prefix, oldState, prefix, newState);
  }
