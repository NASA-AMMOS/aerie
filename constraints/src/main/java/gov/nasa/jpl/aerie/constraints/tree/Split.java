...
public final class Split<I extends IntervalContainer<?>> implements Expression<Spans> {
  ...
  public Spans evaluate(
    ...
    return intervals.split(
        ...
        this.internalStartInclusivity,
        this.internalEndInclusivity);
  }
  ...
  public String prettyPrint(final String prefix) {
    return String.format(
        "\n%s(split %s into %s)",
        prefix, this.intervals.prettyPrint(prefix + "  "), this.numberOfSubIntervals);
  }
  ...
  public boolean equals(final Object o) {
    ...
    Split<?> split = (Split<?>) o;
    return numberOfSubIntervals == split.numberOfSubIntervals
        && Objects.equals(intervals, split.intervals);
  }
