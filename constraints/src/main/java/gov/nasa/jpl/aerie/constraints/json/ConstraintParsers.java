...
public final class ConstraintParsers {
  ...
  static final JsonParser<IntervalAlias> intervalAliasP =
      productP
          ...
          .field("alias", stringP)
          .map(
              untuple((kind, alias) -> new IntervalAlias(alias)), $ -> tuple(Unit.UNIT, $.alias()));
  ...
  static final JsonParser<AbsoluteInterval> absoluteIntervalP =
      productP
          ...
          .map(
              untuple(
                  (kind, start, end, startInclusivity, endInclusivity) ->
                      new AbsoluteInterval(start, end, startInclusivity, endInclusivity)),
  ...
  static <P extends Profile<P>> JsonParser<AssignGaps<P>> assignGapsF(
      final JsonParser<Expression<P>> profileParser) {
    return productP
        ...
        .map(
            untuple(
                (kind, originalProfile, defaultProfile) ->
                    new AssignGaps<P>(originalProfile, defaultProfile)),
  ...
  static final JsonParser<DiscreteResource> discreteResourceP =
      productP
          ...
          .field("name", stringP)
          .map(untuple((kind, name) -> new DiscreteResource(name)), $ -> tuple(Unit.UNIT, $.name));
  ...
  public static JsonParser<Expression<DiscreteProfile>> discreteProfileExprF(
      JsonParser<ProfileExpression<?>> profileExpressionP,
      JsonParser<Expression<Spans>> spansExpressionP) {
    return recursiveP(
        selfP ->
            chooseP(
                discreteResourceP,
  ...
  public static JsonParser<StructExpressionAt> structExpressionF(
      JsonParser<ProfileExpression<?>> profileParser) {
    return productP
  ...
  static JsonParser<ListExpressionAt> listExpressionF(
      JsonParser<ProfileExpression<?>> profileParser) {
    return productP
  ...
  static final JsonParser<RealResource> realResourceP =
      productP
          ...
          .field("name", stringP)
          .map(untuple((kind, name) -> new RealResource(name)), $ -> tuple(Unit.UNIT, $.name));
  ...
  static JsonParser<Plus> plusF(
      final JsonParser<Expression<LinearProfile>> linearProfileExpressionP) {
    return productP
  ...
  static JsonParser<Times> timesF(
      final JsonParser<Expression<LinearProfile>> linearProfileExpressionP) {
    return productP
  ...
  static JsonParser<Rate> rateF(
      final JsonParser<Expression<LinearProfile>> linearProfileExpressionP) {
    return productP
        .field("kind", literalP("RealProfileRate"))
        .field("profile", linearProfileExpressionP)
        .map(untuple((kind, profile) -> new Rate(profile)), $ -> tuple(Unit.UNIT, $.profile));
  }

  static <I extends IntervalContainer<I>> JsonParser<AccumulatedDuration<I>> accumulatedDurationF(
      final JsonParser<Expression<I>> intervalExpressionP) {
    return productP
  ...
  private static JsonParser<Expression<LinearProfile>> linearProfileExprF(
      JsonParser<Expression<Windows>> windowsP, JsonParser<Expression<Spans>> spansP) {
    return recursiveP(
        selfP ->
            chooseP(
                realResourceP,
  ...
  public static JsonParser<ProfileExpression<?>> profileExpressionF(
      JsonParser<Expression<Spans>> spansExpressionP,
      JsonParser<Expression<LinearProfile>> linearProfileExprP) {
    return recursiveP(
        selfP ->
            chooseP(
                linearProfileExprP.map(ProfileExpression::new, $ -> $.expression),
                discreteProfileExprF(selfP, spansExpressionP)
                    .map(ProfileExpression::new, $ -> $.expression),
                durationExprP.map(
                    $ -> new ProfileExpression<>(new DiscreteProfileFromDuration($)),
                    $ -> ((DiscreteProfileFromDuration) $.expression).duration())));
  }

  static JsonParser<Transition> transitionP(
      JsonParser<ProfileExpression<?>> profileExpressionP,
      JsonParser<Expression<Spans>> spansExpressionP) {
    return productP
  ...
  static final JsonParser<StartOf> startOfP =
      productP
          ...
          .field("alias", stringP)
          .map(
              untuple((kind, alias) -> new StartOf(alias)), $ -> tuple(Unit.UNIT, $.activityAlias));
  ...
  static final JsonParser<DurationLiteral> durationLiteralP =
      durationP.map(DurationLiteral::new, DurationLiteral::duration);
  ...
  static JsonParser<ShiftBy> shiftByF(JsonParser<Expression<Windows>> windowsExpressionP) {
    return productP
        ...
        .map(
            untuple(
                (kind, windowsExpression, fromStart, fromEnd) ->
                    new ShiftBy(windowsExpression, fromStart, fromEnd)),
  ...
  static final JsonParser<EndOf> endOfP =
      productP
          ...
          .field("alias", stringP)
          .map(untuple((kind, alias) -> new EndOf(alias)), $ -> tuple(Unit.UNIT, $.activityAlias));

  static <P extends Profile<P>> JsonParser<Equal<P>> equalF(
      final JsonParser<Expression<P>> expressionParser) {
    return productP
  ...
  static <P extends Profile<P>> JsonParser<NotEqual<P>> notEqualF(
      final JsonParser<Expression<P>> expressionParser) {
    return productP
  ...
  static JsonParser<LessThan> lessThanF(
      final JsonParser<Expression<LinearProfile>> linearProfileExpressionP) {
    return productP
  ...
  static JsonParser<LongerThan> longerThanP(JsonParser<Expression<Windows>> windowsExpressionP) {
    return productP
        ...
        .map(
            untuple(
                (kind, windowsExpression, duration) -> new LongerThan(windowsExpression, duration)),
  ...
  static JsonParser<ShorterThan> shorterThanP(JsonParser<Expression<Windows>> windowsExpressionP) {
    return productP
        ...
        .map(
            untuple(
                (kind, windowsExpression, duration) ->
                    new ShorterThan(windowsExpression, duration)),
            $ -> tuple(Unit.UNIT, $.windows, $.duration));
  }

  static JsonParser<LessThanOrEqual> lessThanOrEqualF(
      final JsonParser<Expression<LinearProfile>> linearProfileExpressionP) {
    return productP
  ...
  static JsonParser<GreaterThan> greaterThanF(
      final JsonParser<Expression<LinearProfile>> linearProfileExpressionP) {
    return productP
  ...
  static JsonParser<GreaterThanOrEqual> greaterThanOrEqualF(
      final JsonParser<Expression<LinearProfile>> linearProfileExpressionP) {
    return productP
  ...
  static JsonParser<Not> notF(final JsonParser<Expression<Windows>> windowsExpressionP) {
    return productP
        ...
        .map(untuple((kind, expr) -> new Not(expr)), $ -> tuple(Unit.UNIT, $.expression));
  }

  static <I extends IntervalContainer<I>> JsonParser<Starts<I>> startsF(
      final JsonParser<Expression<I>> intervalExpressionP) {
    return productP
        .field("kind", literalP("IntervalsExpressionStarts"))
        .field("expression", intervalExpressionP)
        .map(untuple((kind, expr) -> new Starts<I>(expr)), $ -> tuple(Unit.UNIT, $.expression));
  }

  static <I extends IntervalContainer<I>> JsonParser<Ends<I>> endsF(
      final JsonParser<Expression<I>> intervalsExpressionP) {
    return productP
        .field("kind", literalP("IntervalsExpressionEnds"))
        .field("expression", intervalsExpressionP)
        .map(untuple((kind, expr) -> new Ends<I>(expr)), $ -> tuple(Unit.UNIT, $.expression));
  }

  static <I extends IntervalContainer<I>> JsonParser<Split<I>> splitF(
      final JsonParser<Expression<I>> intervalExpressionP) {
    return productP
  ...
  static JsonParser<WindowsFromSpans> windowsFromSpansF(
      final JsonParser<Expression<Spans>> spansExpressionP) {
    return productP
  ...
  static JsonParser<ForEachActivitySpans> forEachActivitySpansF(
      final JsonParser<Expression<Spans>> spansExpressionP) {
    return productP
        ...
        .map(
            untuple(
                (kind, actType, alias, expression) ->
                    new ForEachActivitySpans(actType, alias, expression)),
            $ -> tuple(Unit.UNIT, $.activityType, $.alias, $.expression));
  }

  static JsonParser<ForEachActivityViolations> forEachActivityViolationsF(
      final JsonParser<Expression<List<Violation>>> violationListExpressionP) {
    return productP
        ...
        .map(
            untuple(
                (kind, actType, alias, expression) ->
                    new ForEachActivityViolations(actType, alias, expression)),
            $ -> tuple(Unit.UNIT, $.activityType, $.alias, $.expression));
  }

  public static JsonParser<ValueAt<?>> valueAtExpressionF(
      JsonParser<ProfileExpression<?>> profileExpressionP,
      JsonParser<Expression<Spans>> spansExpressionP) {
    return productP
  ...
  static JsonParser<Changes<?>> changesF(
      JsonParser<Expression<Spans>> spansExpressionP,
      JsonParser<Expression<LinearProfile>> linearProfileExprP) {
    return productP
  ...
  private static JsonParser<Expression<Windows>> windowsExpressionF(
      JsonParser<Expression<Spans>> spansP,
      JsonParser<Expression<LinearProfile>> linearProfileExprP) {
    return recursiveP(
        selfP ->
            chooseP(
                ...
                equalF(
                    discreteProfileExprF(profileExpressionF(spansP, linearProfileExprP), spansP)),
  ...
  static JsonParser<SpansFromWindows> spansFromWindowsF(
      JsonParser<Expression<Windows>> windowsExpressionP) {
    return productP
  ...
  private static JsonParser<Expression<Spans>> spansExpressionF(
      JsonParser<Expression<Windows>> windowsP) {
    return recursiveP(
        selfP ->
            chooseP(
                spansIntervalP,
  ...
  public static final JsonParser<Expression<Windows>> windowsExpressionP =
      recursiveP(
          selfP ->
              windowsExpressionF(
                  spansExpressionF(selfP), linearProfileExprF(selfP, spansExpressionF(selfP))));
  public static final JsonParser<Expression<LinearProfile>> linearProfileExprP =
      recursiveP(
          selfP -> linearProfileExprF(windowsExpressionP, spansExpressionF(windowsExpressionP)));
  public static final JsonParser<Expression<Spans>> spansExpressionP =
      recursiveP(selfP -> spansExpressionF(windowsExpressionF(selfP, linearProfileExprP)));
  public static final JsonParser<ProfileExpression<?>> profileExpressionP =
      profileExpressionF(spansExpressionP, linearProfileExprP);
  public static final JsonParser<Expression<DiscreteProfile>> discreteProfileExprP =
      discreteProfileExprF(profileExpressionP, spansExpressionP);
