...
public final class ForEachActivityViolations implements Expression<List<Violation>> {
  ...
  public ForEachActivityViolations(
      final String activityType, final String alias, final Expression<List<Violation>> expression) {
  ...
  public String prettyPrint(final String prefix) {
    return String.format(
        ...
        prefix, this.activityType, this.alias, this.expression.prettyPrint(prefix + "  "));
  }
