...
public final class Interval implements Comparable<Interval>{
  ...
  public static Interval window(final Duration start, final Duration end) {
  ...
  public static Interval window(final long start, final long end, final Duration unit) {
