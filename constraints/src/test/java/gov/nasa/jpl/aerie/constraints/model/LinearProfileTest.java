...
public class LinearProfileTest {
  ...
  public void testLessThan() {
    ...
    final var expected = new Windows();
    expected.add(Interval.between(8, Exclusive, 14, Exclusive, SECONDS));
  ...
  public void testLessThanOrEqualTo() {
    ...
    expected.add(Interval.between(16, Inclusive, 20, Inclusive, SECONDS));
  ...
  public void testGreaterThan() {
    ...
    expected.add(Interval.between(14, Exclusive, 16, Exclusive, SECONDS));
  ...
  public void testGreaterThanOrEqualTo() {
    ...
    final var expected = new Windows();
    expected.add(Interval.between( 0, Inclusive,  8, Inclusive, SECONDS));
