...
public class LinearProfileTimeDomainTest {
  ...
  public void testChangePoints() {
    ...
    expected.add(Interval.between(10, Exclusive, 15, Inclusive, SECONDS));
  ...
  public void testLessThan() {
    ...
    final var expected = new Windows();
    expected.add(Interval.between(9, Inclusive, 14, Exclusive, SECONDS));
  ...
  public void testLessThanOrEqualTo() {
    ...
    final var expected = new Windows();
    expected.add(Interval.between( 0, Inclusive,  2, Inclusive, SECONDS));
    expected.add(Interval.between( 6, Inclusive, 8, Inclusive, SECONDS));
  ...
  public void testGreaterThan() {
    ...
    final var expected = new Windows();
    expected.add(Interval.between( 2, Exclusive,  6, Exclusive, SECONDS));
    expected.add(Interval.between(14, Exclusive, 15, Inclusive, SECONDS));
  ...
  public void testGreaterThanOrEqualTo() {
    ...
    final var expected = new Windows();
    expected.add(Interval.at(8, SECONDS));
    expected.add(Interval.between(14, Inclusive, 20, Inclusive, SECONDS));
  ...
  public void testEqualTo() {
    ...
    final var expected = new Windows();
    expected.add(Interval.between( 7, Inclusive,  8, Inclusive, SECONDS));
    expected.add(Interval.at(14, SECONDS));
    expected.add(Interval.between( 16, Inclusive,  17, Inclusive, SECONDS));
  ...
  public void testNotEqualTo() {
    ...
    final var expected = new Windows();
    expected.add(Interval.between(2, Exclusive, 6, Exclusive, SECONDS));
    expected.add(Interval.between(8, Exclusive, 11, Inclusive, SECONDS));
