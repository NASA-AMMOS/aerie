...
public class ASTTests {
  ...
  public void testAssignGaps() {
    final var simResults =
        new SimulationResults(
            Instant.EPOCH, Interval.between(0, 20, SECONDS), List.of(), Map.of(), Map.of());

    final var originalWindows =
        new Windows()
            .set(Interval.between(-2, -1, SECONDS), true)
            .set(Interval.between(1, 2, SECONDS), false);

    final var defaultWindows =
        new Windows(false).set(Interval.between(Duration.ZERO, Duration.MAX_VALUE), true);

    final var result =
        new AssignGaps<>(Supplier.of(originalWindows), Supplier.of(defaultWindows))
    ...
    final var expected =
        new Windows(false)
            ...
            .set(
                Interval.between(Duration.of(2, SECONDS), Exclusive, Duration.MAX_VALUE, Inclusive),
                true);
  ...
  public void testWindowsValue() {
    ...
    final var result =
        new WindowsValue(true, Optional.empty()).evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testNot() {
    ...
    final var result =
        new Not(Supplier.of(windows)).evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testWindowsStarts() {
    ...
    final var result =
        new Starts<>(Supplier.of(windows)).evaluate(simResults, new EvaluationEnvironment());
        ...
        new Windows()
            .set(
                Interval.between(
                    Duration.MIN_VALUE,
                    Inclusive,
                    Duration.MIN_VALUE.plus(Duration.HOUR),
                    Inclusive),
                false)
            .set(Interval.between(-10, 10, SECONDS), false)
  ...
  public void testWindowsEnds() {
    ...
    final var windows =
        new Windows()
            .set(
                Interval.between(Duration.MAX_VALUE.minus(Duration.HOUR), Duration.MAX_VALUE), true)
            .set(Interval.between(-10, 10, SECONDS), false)
            .set(Interval.between(0, 1, SECONDS), true)
    ...
    final var result =
        new Ends<>(Supplier.of(windows)).evaluate(simResults, new EvaluationEnvironment());

    final var expected =
        new Windows()
            .set(
                Interval.between(
                    Duration.MAX_VALUE.minus(Duration.HOUR),
                    Inclusive,
                    Duration.MAX_VALUE,
                    Inclusive),
                false)
  ...
  public void testSpansStarts() {
    ...
    final var result =
        new Starts<>(Supplier.of(spans)).evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testSpansEnds() {
    ...
    final var result =
        new Ends<>(Supplier.of(spans)).evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testSplitWindows() {
    ...
    final var result =
        new WindowsFromSpans(new Split<>(Supplier.of(windows), 3, Exclusive, Exclusive))
            .evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testSplitSpans() {
    ...
    final var result =
        new Split<>(Supplier.of(spans), 3, Inclusive, Exclusive)
            .evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testUnsplittableInterval() {
    ...
    final var spans = new Spans(Interval.at(5, SECONDS));

    assertThrows(
        UnsplittableSpanException.class,
        () ->
            new Split<Spans>(Supplier.of(spans), 3, Inclusive, Exclusive)
                .evaluate(simResults, new EvaluationEnvironment()));
  }
  ...
  public void testAnd() {
    ...
    final var result =
        new And(Supplier.of(left), Supplier.of(right))
            .evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testOr() {
    final var simResults =
        new SimulationResults(
            Instant.EPOCH, Interval.between(0, 26, SECONDS), List.of(), Map.of(), Map.of());
    ...
    final var result =
        new Or(Supplier.of(left), Supplier.of(right))
            .evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testExpandBy() {
    ...
    final var result =
        new ShiftBy(Supplier.of(left), Supplier.of(expandByFromStart), Supplier.of(expandByFromEnd))
            .evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testShrink() {
    ...
    final var result =
        new ShiftBy(Supplier.of(left), Supplier.of(clampFromStart), Supplier.of(clampFromEnd))
            .evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testRealValue() {
    ...
    final var result =
        new RealValue(7, 3.14, Optional.empty()).evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testDiscreteValue() {
    ...
    final var result =
        new DiscreteValue(SerializedValue.of("IDLE"), Optional.empty())
            .evaluate(simResults, new EvaluationEnvironment());

    final var expected =
        new DiscreteProfile(Segment.of(simResults.bounds, SerializedValue.of("IDLE")));
  ...
  public void testRealParameter() {
    final var act =
        new ActivityInstance(
            1, "typeA", Map.of("p1", SerializedValue.of(2)), Interval.between(0, 10, SECONDS));

    final var simResults =
        new SimulationResults(
            Instant.EPOCH, Interval.between(0, 20, SECONDS), List.of(act), Map.of(), Map.of());
    final var environment =
        new EvaluationEnvironment(Map.of("act", act), Map.of(), Map.of(), Map.of(), Map.of());

    final var result = new RealParameter("act", "p1").evaluate(simResults, environment);

    final var expected =
        new LinearProfile(Segment.of(FOREVER, new LinearEquation(Duration.ZERO, 2, 0)));
                ...
                "real1",
                    new LinearProfile(
                        Segment.of(
                            ...
                            new LinearEquation(Duration.of(1, SECONDS), 0, 1))),
                "real2",
                    new LinearProfile(
                        Segment.of(
                            Interval.at(2, SECONDS),
                            new LinearEquation(Duration.of(2, SECONDS), 0, 1))),
                "real3",
                    new LinearProfile(
                        Segment.of(
                            Interval.at(3, SECONDS),
                            new LinearEquation(Duration.of(3, SECONDS), 0, 1)))),
            Map.of(
                "discrete1",
                    new DiscreteProfile(
                        Segment.of(Interval.at(4, SECONDS), SerializedValue.of("one"))),
                "discrete2",
                    new DiscreteProfile(
                        Segment.of(Interval.at(5, SECONDS), SerializedValue.of("two"))),
                "discrete3",
                    new DiscreteProfile(
                        Segment.of(Interval.at(6, SECONDS), SerializedValue.of("three")))));

    final var result =
        new DiscreteResource("discrete2").evaluate(simResults, new EvaluationEnvironment());
    ...
    final var simResults =
        new SimulationResults(
            ...
            Map.of(
                "discrete1",
                new DiscreteProfile(
                    Segment.of(Interval.between(1, 2, SECONDS), SerializedValue.of("one")),
        ...
        new ValueAt<>(
                ...
                new SpansFromWindows(
                    new WindowsWrapperExpression(
                        new Windows(false).set(Interval.at(Duration.of(3, SECONDS)), true))))
            .evaluate(simResults, new EvaluationEnvironment());
            ...
            Map.of(
                "discrete1",
                    new DiscreteProfile(
                        Segment.of(Interval.at(4, SECONDS), SerializedValue.of("one"))),
                "discrete2",
                    new DiscreteProfile(Segment.of(Interval.at(5, SECONDS), SerializedValue.of(2))),
                "discrete3",
                    new DiscreteProfile(
                        Segment.of(Interval.at(6, SECONDS), SerializedValue.of("three")))));
  ...
  public void testRealResourceOnDiscrete() {
    ...
    final var result =
        new RealResource("discrete2").evaluate(simResults, new EvaluationEnvironment());

    final var expected =
        new LinearProfile(
            Segment.of(Interval.at(5, SECONDS), new LinearEquation(Duration.of(5, SECONDS), 2, 0)));
  ...
  public void testForEachActivity() {
    ...
    final var spansSupplied =
        new Windows(Segment.of(Interval.FOREVER, false), Segment.of(interval(4, 6, SECONDS), true))
            .intoSpans(simResults.bounds);
    final var result =
        new ForEachActivitySpans("TypeA", "act", new Supplier<>(spansSupplied))
            .evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testNestedForEachActivityViolations() {
    ...
    final var violation =
        new Violation(List.of(), List.of(), new Windows(interval(4, 6, SECONDS), true));
    final var result =
        new ForEachActivityViolations(
                "TypeA",
                "act",
                new ForEachActivityViolations("TypeB", "act", new Supplier<>(List.of(violation))))
            .evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testNestedForEachActivitySpans() {
    ...
    final var result =
        new ForEachActivitySpans(
                "TypeA", "act", new ForEachActivitySpans("TypeB", "act", new Supplier<>(spans)))
            .evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testViolationsOf() {
    ...
    final var result =
        new ViolationsOfWindows(new Supplier<>(windows))
            .evaluate(simResults, new EvaluationEnvironment());
        ...
        List.of(
            new Violation(
                ...
                List.of(
                    ...
                    Interval.between(
                        Duration.of(20, SECONDS), Exclusive, Duration.MAX_VALUE, Inclusive))));
  ...
  public void testDuring() {
    ...
    final var activityInstance =
        new ActivityInstance(1, "TypeA", Map.of(), Interval.between(4, 8, SECONDS));

    final var environment =
        new EvaluationEnvironment(
            Map.of("act", activityInstance), Map.of(), Map.of(), Map.of(), Map.of());
    ...
    final var expected =
        new Spans(
            List.of(
                Segment.of(
                    interval(4, 8, SECONDS), Optional.of(new Spans.Metadata(activityInstance)))));
  ...
  public void testStartOf() {
    ...
    final var environment =
        new EvaluationEnvironment(
            Map.of(
                "act", new ActivityInstance(1, "TypeA", Map.of(), Interval.between(4, 8, SECONDS))),
            Map.of(),
            Map.of(),
            Map.of(),
            Map.of());
    ...
    final var expected = new Windows(Segment.of(FOREVER, false), Segment.of(at(4, SECONDS), true));
  ...
  public void testEndOf() {
    ...
    final var expected = new Windows(Segment.of(FOREVER, false), Segment.of(at(8, SECONDS), true));
  ...
  public void testLongerThan() {
    ...
    final var result =
        new LongerThan(Supplier.of(left), Supplier.of(right))
            .evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testShorterThan() {
    ...
    final var right = Duration.of(2, SECONDS);
    final var result =
        new ShorterThan(Supplier.of(left), Supplier.of(right))
            .evaluate(simResults, new EvaluationEnvironment());
  ...
  public void testSpansAlias() {
    ...
    final var spans = new Spans(Interval.between(0, 1, SECONDS));

    final var environment =
        new EvaluationEnvironment(
            Map.of(), Map.of("my spans", spans), Map.of(), Map.of(), Map.of());
  ...
  public void testSpansFromInterval() {
    ...
    final var interval =
        new AbsoluteInterval(
            ...
            Optional.of(Instant.ofEpochSecond(10)),
            Optional.empty(),
            Optional.empty());
