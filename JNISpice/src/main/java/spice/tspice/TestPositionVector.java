...
*/
public class TestPositionVector extends Object
{
   ...
   /**
   Test PositionVector and associated classes.
   */
   public static boolean f_PositionVector()
      ...
      throws SpiceException
   {
      ...
      try
      {
         ...
         try
         {
            ...
            pos         = new PositionVector( target, et, frame, abcorr,
                                                                    observer );
         ...
         p0  = new PositionVector( v0 );

         pos = new PositionVector( p0 );
         ...
         //
         p0 = new PositionVector(  v0.scale(2.0)  );

         p1 = new PositionVector( v0 );
         ...
         pos      = new PositionVector( target, et, frame, abcorr, observer );
         ...
         p0      = new PositionVector( Alpha, et, frame, abcorr, observer );
         p1      = new PositionVector( Beta,  et, frame, abcorr, observer );
         ...
         PositionVector p3 = new PositionVector(  p1.scale( scale )  );
         ...
         */
         ...
         p0         = new PositionVector( new Vector3( 3.0, 4.0, 12.0 )  );
