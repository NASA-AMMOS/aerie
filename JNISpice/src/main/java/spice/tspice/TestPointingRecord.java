...
*/
public class TestPointingRecord extends Object
{
   ...
   */
      ...
      throws SpiceException
   {
      ...
      try
      {
         ...
         JNITestutils.topen ( "f_PointingRecord" );
         ...
         JNITestutils.tcase ( "Attempt to construct PointingRecord with " +
                              "no CKs loaded."                               );
         ...
         try
         {
            ...
            prec   = new PointingRecord( inst, et, ref0, tol );
         ...
         JNITestutils.tcase ( "Attempt to get C-matrix from PointingRecord " +
                              "when no data were found."                     );
         ...
         JNITestutils.tcase ( "Attempt to get output SCLK time from " +
                              "PointingRecord when no data were found."      );
         ...
         JNITestutils.tcase ( "Create a new CK containing one type 3 " +
                              "segment with AV and one without AV." );
         ...
         //
         // Create a second segment without AV.
         //
         ...
         for ( i = 0;  i < n;  i++ )
         {
            ...
            prec = new PointingRecord( inst, ticks, ref0, tol );
         ...
         for ( i = 0;  i < n;  i++ )
         {
            ...
            prec = new PointingRecord( inst, ticks, ref1, tol );
            ...
            ok    = JNITestutils.chcksl( "found" + "(" + i + ")",
                                                                 found, true );
         ...
         if ( found )
         {
            ...
            //
            ok = JNITestutils.chcksc( "frame" + "(" + i + ")",
                                      prec1.getReferenceFrame().getName(),
                                      "=",
                                      prec.getReferenceFrame().getName()   );
            ...
            //
            ok = JNITestutils.chcksd( "request time" + "(" + i + ")",
                               prec1.getRequestSCLKTime().getContinuousTicks(),
                                      "=",
                               prec.getRequestSCLKTime().getContinuousTicks(),
                                      0.0                          );
            ...
            //
            ok = JNITestutils.chcksd( "actual time" + "(" + i + ")",
                               prec1.getActualSCLKTime().getContinuousTicks(),
                                      "=",
                               prec.getActualSCLKTime().getContinuousTicks(),
                                      0.0                                    );
         ...
         //
         // Since the fields of PointingRecord are package private, we can't
         // examine them here, since this test family doesn't belong to the
         // spice.basic package. Just make sure that the record indicates
         // pointing "was not found."
         //

         prec = new PointingRecord();
         ...
         prec = new PointingRecord( new Instrument( -10001 ), ticks,
                                                                   ref1, tol );
         ...
         JNITestutils.tcase ( "Look for data for instrument -9999 at " +
                              "a time not covered by the CK."                );
