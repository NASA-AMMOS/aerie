                      ...
                      ValueSchema.ofStruct(
                          Map.of(
                              ...
                              ValueSchema.ofSeries(
                                  ValueSchema.ofStruct(
                                      Map.of("subsubfield1", ValueSchema.REAL)))))),
                  Map.of()),
              new MissionModelService.ActivityType(
                  "SampleActivity2",
                  Map.of("quantity", ValueSchema.REAL),
                  Map.of("my preset", Map.of("quantity", SerializedValue.of(5)))),
              new MissionModelService.ActivityType("SampleActivityEmpty", Map.of(), Map.of())),
          List.of(
              new MissionModelService.ResourceType("/sample/resource/1", ValueSchema.REAL),
              new MissionModelService.ResourceType(
                  "/sample/resource/3",
                  ValueSchema.ofVariant(
                      List.of(
                          new ValueSchema.Variant("option1", "option1"),
