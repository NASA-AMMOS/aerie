...
public record GraphQLMerlinDatabaseService(URI merlinGraphqlURI, String hasuraGraphQlAdminSecret) implements MerlinDatabaseService.OwnerRole {
   ...
   * signature of callers cleanly matching the MerlinDatabaseService interface
   *
  ...
  throws IOException, NoSuchPlanException, MerlinServiceException
  {
    ...
    final Map<SchedulingActivity, ActivityDirectiveId> activityToId = createAllPlanActivityDirectives(planId, plan, activityToGoalId, schedulerModel);
  ...
  throws IOException, NoSuchPlanException, MerlinServiceException
  {
    final var ids = new HashMap<SchedulingActivity, ActivityDirectiveId>();
...
@Override
  ...
  public Map<SchedulingActivity, ActivityDirectiveId> createActivityDirectives(
      final PlanId planId,
  ...
  throws IOException, NoSuchPlanException, MerlinServiceException
  {
    ...
    final Map<SchedulingActivity, ActivityDirectiveId> instanceToInstanceId = new HashMap<>();
    try {
  ...
  private Map<SimulatedActivityId, ActivityInstance> getSimulatedActivities(SimulationDatasetId datasetId, Instant startSimulation)
  ...
  throws MerlinServiceException, IOException
  {
    ...
    try(var executorService = Executors.newFixedThreadPool(3)) {
      Future<Map<SimulatedActivityId, ActivityInstance>> futureSimulatedActivities = executorService.submit(() -> getSimulatedActivities(
  ...
  private Map<SimulatedActivityId, ActivityInstance> parseSimulatedActivities(JsonArray simulatedActivitiesArray, Instant simulationStart)
