...
public final class Registrar {
  ...
  public <Value> void discrete(
      final String name, final Resource<Value> resource, final ValueMapper<Value> mapper) {
  ...
  private static <Value> void addDiscreteResource(
    ...
    initializer.resource(
        name,
        new gov.nasa.jpl.aerie.merlin.protocol.model.Resource<Value>() {
          @Override
  ...
  private static void addRealResource(
      final Initializer initializer, final String name, final Resource<RealDynamics> resource) {
    initializer.resource(
        name,
        new gov.nasa.jpl.aerie.merlin.protocol.model.Resource<RealDynamics>() {
          @Override
  ...
  public <Event> void topic(
      final String name, final CellRef<Event, ?> ref, final ValueMapper<Event> mapper) {
