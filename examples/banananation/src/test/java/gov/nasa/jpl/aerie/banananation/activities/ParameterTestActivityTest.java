...
public class ParameterTestActivityTest {
  ...
  public void testDeserialization() throws InstantiationException {
    ...
    final ParameterTestActivity deserializedActivity =
        this.mapper.getInputType().instantiate(sourceActivity);
  ...
  public void testSerialization() throws InstantiationException {
    ...
    final Map<String, SerializedValue> activityArgs =
        this.mapper.getInputType().getArguments(sourceActivity);

    final ParameterTestActivity deserializedActivity =
        this.mapper.getInputType().instantiate(activityArgs);
  ...
  private Map<String, SerializedValue> createSerializedArguments() {
    ...
    // Duration Parameter
    arguments.put(
        "testDuration", new DurationValueMapper().serializeValue(testValues.testDuration));
                    ...
                    List.of(
                        ...
                        SerializedValue.of(
                            List.of(
                                ...
                                SerializedValue.of(
                                    testValues.intListArrayArray[1][1].get(1)))))))));
