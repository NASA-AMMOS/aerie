...
public final class SimulatedActivityTest {
  ...
  public void testUnspecifiedArgInSimulatedActivity() {
    final var schedule =
        SimulationUtility.buildSchedule(
            Pair.of(duration(0, SECONDS), new SerializedActivity("PeelBanana", Map.of())),
            Pair.of(
                duration(0, SECONDS),
                new SerializedActivity(
                    ...
                    Map.of(
                        ...
                        "growingDuration",
                            SerializedValue.of(
                                Duration.SECOND.times(2).in(Duration.MICROSECONDS))))));
    ...
    simulationResults.unfinishedActivities.forEach(
        (id, act) -> {
  ...
  public void testCollectAllActivitiesInResults() {
            ...
            Pair.of(
                ...
                new SerializedActivity(
                    ...
                    Map.of(
                        ...
                        "growingDuration",
                            SerializedValue.of(
                                Duration.SECOND.times(3).in(Duration.MICROSECONDS))))),
            Pair.of(
                duration(0, SECONDS), new SerializedActivity("DecomposingSpawnParent", Map.of())));
    ...
    simulationResults.simulatedActivities.forEach(
        (id, act) -> simulatedActivityTypes.add(act.type()));
    Collection<String> expectedSimulated =
        new HashSet<>(Arrays.asList("PeelBanana", "DecomposingSpawnChild"));
    ...
    simulationResults.unfinishedActivities.forEach(
        (id, act) -> unfinishedActivityTypes.add(act.type()));

    Collection<String> expectedUnfinished =
        new HashSet<>(
