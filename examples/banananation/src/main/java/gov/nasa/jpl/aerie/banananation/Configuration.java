...
public record Configuration(
  ...
  public static final InitialConditions DEFAULT_INITIAL_CONDITIONS =
      new InitialConditions(4.0, 4.0, Flag.A);
  ...
  public static @Template Configuration defaultConfiguration() {
    return new Configuration(
        DEFAULT_PLANT_COUNT, DEFAULT_PRODUCER, DEFAULT_DATA_PATH, DEFAULT_INITIAL_CONDITIONS);
  }
