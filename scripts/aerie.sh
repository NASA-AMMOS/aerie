...
clean() {
  ...
  docker-compose down
  docker stop aerie_plan_1 aerie_tyk_gateway_1 aerie_adaptation_1 aerie_plan_mongo_1 aerie_tyk_redis_1 aerie_tyk_pump_1 aerie_tyk_dashboard_1 aerie_tyk_mongo_1
  docker rm aerie_plan_1 aerie_tyk_gateway_1 aerie_adaptation_1 aerie_plan_mongo_1 aerie_tyk_redis_1 aerie_tyk_pump_1 aerie_tyk_dashboard_1 aerie_tyk_mongo_1
  docker rmi aerie_plan aerie_adaptation
