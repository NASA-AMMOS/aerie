...
class RecordValueMapperTest {
  ...
  void getValueSchema_stringRecord() {
    final var valueSchema =
        new RecordValueMapper<>(
                StringRecord.class,
                List.of(
                    new RecordValueMapper.Component<>(
                        "aString", StringRecord::aString, new StringValueMapper())))
            .getValueSchema();
  ...
  void getValueSchema_multiValueRecord() {
    final var valueSchema =
        new RecordValueMapper<>(
                ...
                List.of(
                    new RecordValueMapper.Component<>(
                        "aString", MultiValueRecord::aString, new StringValueMapper()),
                    new RecordValueMapper.Component<>(
                        "fancy",
                        MultiValueRecord::fancy,
                        new MapValueMapper<>(
                            new StringValueMapper(),
                            new ListValueMapper<>(new BooleanValueMapper())))))
            .getValueSchema();
    assertEquals(
                ...
                ValueSchema.ofSeries(
                    ValueSchema.ofStruct(
                        Map.of(
                            ...
                            ValueSchema.STRING,
                            "value",
                            ValueSchema.ofSeries(ValueSchema.BOOLEAN)))))),
        valueSchema);
  }
  ...
  void deserializeValue_emptyRecord() {
    final var deserializedValue =
        new RecordValueMapper<>(EmptyRecord.class, List.of())
        ...
        new RecordValueMapper<>(
                ...
                List.of(
                    new RecordValueMapper.Component<>(
                        "aString", StringRecord::aString, new StringValueMapper())))
            .deserializeValue(
                SerializedValue.of(Map.of("aString", SerializedValue.of("hello world"))))
            .getSuccessOrThrow();
                                ...
                                List.of(
                                    SerializedValue.of(
                                        Map.of(
                                            ...
                                            "value",
                                                SerializedValue.of(
                                                    List.of(SerializedValue.of(false))))),
                                    SerializedValue.of(
                                        Map.of(
                                            "key", SerializedValue.of("y"),
                                            "value",
                                                SerializedValue.of(
                                                    List.of(SerializedValue.of(true))))))))))
            .getSuccessOrThrow();

    assertEquals(
        new MultiValueRecord(
            "one small step for crayon", Map.of("x", List.of(false), "y", List.of(true))),
        deserializedValue);
  }
  ...
  void serializeValue_emptyRecord() {
    final var serializedValue =
        new RecordValueMapper<>(EmptyRecord.class, List.of()).serializeValue(new EmptyRecord());
  ...
  void serializeValue_stringRecord() {
    ...
    assertEquals(
        SerializedValue.of(Map.of("aString", SerializedValue.of("hello world"))), serializedValue);
  }
            ...
            List.of(
                ...
                SerializedValue.of(
                    Map.of(
                        "key", SerializedValue.of("x"),
                        "value", SerializedValue.of(List.of(SerializedValue.of(false)))))));
    if (SerializedValue.of(
                Map.of(
                    "aString",
                    SerializedValue.of("one small step for crayon"),
                    "fancy",
                    permutation1))
            .equals(serializedValue)
        || SerializedValue.of(
                Map.of(
                    "aString",
                    SerializedValue.of("one small step for crayon"),
                    ...
                    permutation2))
            .equals(serializedValue)) {
      // If either permutation matches, this test has passed. This is to allow for non-deterministic
      // ordering of the map.
    } else {
      // This assert is guaranteed to fail, since both equality checks above have failed. We use
