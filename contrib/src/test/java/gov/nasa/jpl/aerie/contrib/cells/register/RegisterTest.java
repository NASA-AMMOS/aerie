...
public final class RegisterTest {
  ...
  @Test
  @DisplayName(
      "Conflicting writes with different values should mark the conflict flag and have no other"
          + " effect")
  public void differentValueConflicts() {
    ...
    delay(Duration.ZERO);
    assertAll(
        List.of(() -> assertTrue(register.isConflicted()), () -> assertEquals(0, register.get())));
  }

  @Test
  @DisplayName(
      "Conflicting writes with the same value should mark the conflict flag and have no other"
          + " effect")
  ...
  @Test
  @DisplayName(
      "Conflicting writes after a successful write should mark the conflict flag and keep the"
          + " successful write")
