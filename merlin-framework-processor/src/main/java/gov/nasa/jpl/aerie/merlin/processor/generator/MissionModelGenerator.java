...
public record MissionModelGenerator(Elements elementUtils, Types typeUtils, Messager messager) {
  ...
  private static final String COMPUTED_ATTRIBUTES_VALUE_MAPPER_FIELD_NAME =
      "computedAttributesValueMapper";
  ...
  public JavaFile generateMerlinPlugin(final MissionModelRecord missionModel) {
    ...
    final var typeSpec =
        TypeSpec.classBuilder(typeName)
            ...
            .addMethod(
                MethodSpec.methodBuilder("getModelType")
                    .addAnnotation(Override.class)
                    .addModifiers(Modifier.PUBLIC)
                    .returns(missionModel.getModelTypeName())
                    .addStatement("return new $T()", missionModel.getModelTypeName())
                    .build())
            .build();

    return JavaFile.builder(typeName.packageName(), typeSpec).skipJavaLangImports(true).build();
  }
  ...
  public JavaFile generateSchedulerPlugin(final MissionModelRecord missionModel) {
    ...
    final var typeSpec =
        TypeSpec.classBuilder(typeName)
            ...
            .addMethod(
                MethodSpec.methodBuilder("getSchedulerModel")
                    .addAnnotation(Override.class)
                    .addModifiers(Modifier.PUBLIC)
                    .returns(missionModel.getSchedulerModelName())
                    .addStatement("return new $T()", missionModel.getSchedulerModelName())
                    .build())
            .build();
  ...
  public Optional<JavaFile> generateMissionModelConfigurationMapper(
      final MissionModelRecord missionModel, final InputTypeRecord configType) {
    return generateInputType(missionModel, configType, configType.mapper().name.simpleName())
        .map(
            typeSpec ->
                JavaFile.builder(configType.mapper().name.packageName(), typeSpec)
  ...
  public JavaFile generateModelType(final MissionModelRecord missionModel) {
    ...
    final var typeSpec =
        TypeSpec.classBuilder(typeName)
            ...
            .addMethod(
                MethodSpec.methodBuilder("getDirectiveTypes")
                    .addModifiers(Modifier.PUBLIC)
                    .addAnnotation(Override.class)
                    .returns(
                        ParameterizedTypeName.get(
                            ...
                            ParameterizedTypeName.get(
                                ClassName.get(
                                    gov.nasa.jpl.aerie.merlin.framework.ActivityMapper.class),
                                ClassName.get(missionModel.topLevelModel),
                                WildcardTypeName.subtypeOf(Object.class),
                                WildcardTypeName.subtypeOf(Object.class))))
                    .addStatement("return $T.$L", missionModel.getTypesName(), "directiveTypes")
                    .build())
            .addMethod(
                MethodSpec.methodBuilder("getConfigurationType")
                    .addModifiers(Modifier.PUBLIC)
                    .addAnnotation(Override.class)
                    .returns(
                        missionModel
            ...
            .addMethod(
                MethodSpec.methodBuilder("instantiate")
                    .addModifiers(Modifier.PUBLIC)
                    .addAnnotation(Override.class)
                    .addParameter(ClassName.get(Instant.class), "planStart", Modifier.FINAL)
                    .addParameter(
                        missionModel
                            .modelConfigurationType
                            .map($ -> ClassName.get($.declaration()))
                    ...
                    .addStatement("$T.registerTopics($L)", missionModel.getTypesName(), "builder")
                    .addCode("\n")
                    .addStatement(
                        "final var $L = new $T($L)",
                        "registrar",
  ...
  private static CodeBlock generateMissionModelInstantiation(
            ...
            configType ->
                missionModel.expectsPlanStart
                    ? CodeBlock.of(
                        ...
                        "planStart",
                        "configuration")
                    : CodeBlock.of("new $T($L, $L)", modelClassName, "registrar", "configuration"))
        .orElseGet(
            () ->
                missionModel.expectsPlanStart
                    ? CodeBlock.of("new $T($L, $L)", modelClassName, "registrar", "planStart")
                    : CodeBlock.of("new $T($L)", modelClassName, "registrar"));
  }
  ...
  public JavaFile generateSchedulerModel(final MissionModelRecord missionModel) {
    ...
    final var typeSpec =
        TypeSpec.classBuilder(typeName)
            ...
            .addMethod(
                MethodSpec.methodBuilder("getDurationTypes")
                    .addModifiers(Modifier.PUBLIC)
                    .addAnnotation(Override.class)
                    .returns(ParameterizedTypeName.get(Map.class, String.class, DurationType.class))
                    .addStatement(
                        "final var result = new $T()",
                        ParameterizedTypeName.get(HashMap.class, String.class, DurationType.class))
                    .addCode(
                        missionModel.activityTypes.stream()
                            .map(
                                activityTypeRecord ->
                                    CodeBlock.builder()
                                        .addStatement(
                                            ...
                                            activityTypeRecord
                                                ...
                                                .map(
                                                    $ -> {
                                                      if ($.durationParameter().isPresent())
                                                        return CodeBlock.of(
                                                            "controllable(\"$L\")",
                                                            $.durationParameter().get());
                                                      else if ($.fixedDurationExpr().isPresent())
                                                        return CodeBlock.of(
                                                            "fixed($L.$L)",
                                                            activityTypeRecord
                                                                .fullyQualifiedClass(),
                                                            $.fixedDurationExpr().get());
            ...
            .addMethods(
                missionModel.activityTypes.stream()
                    .flatMap(
                        entry ->
                            Stream.of(
                                MethodSpec.methodBuilder("spawn")
                                    ...
                                    .addStatement(
                                        ...
                                        "activity")
                                    .build(),
                                MethodSpec.methodBuilder("defer")
                                    .addModifiers(Modifier.PUBLIC, Modifier.STATIC)
                                    .addParameter(
                                        ClassName.get(Duration.class), "duration", Modifier.FINAL)
                                    .addParameter(
                                        ClassName.get(missionModel.topLevelModel),
                                        "model",
                                        Modifier.FINAL)
                                ...
                                MethodSpec.methodBuilder("defer")
                                    .addModifiers(Modifier.PUBLIC, Modifier.STATIC)
                                    .addParameter(
                                        ParameterSpec.builder(TypeName.LONG, "quantity")
        ...
        TypeSpec.classBuilder(typeName)
            ...
            .addField(
                FieldSpec.builder(
                    ...
                    .build())
            .addMethod(
                MethodSpec.methodBuilder("registerTopics")
                    .addModifiers(Modifier.PUBLIC, Modifier.STATIC)
                    ...
                    .build())
            .addMethod(
                MethodSpec.methodBuilder("registerDirectiveType")
  ...
  public Optional<TypeSpec> generateInputType(
      final MissionModelRecord missionModel, final InputTypeRecord inputType, final String name) {
    ...
    return Optional.of(
        TypeSpec.classBuilder(name)
            ...
            // TODO: Add an originating element for each of the mapper rulesets associated with the
            // mission model.
            .addAnnotation(
                AnnotationSpec.builder(javax.annotation.processing.Generated.class)
                    .addMember("value", "$S", MissionModelProcessor.class.getCanonicalName())
                    ...
                    .map(
                        parameter ->
                            FieldSpec.builder(
                                    ParameterizedTypeName.get(
                                        ClassName.get(
                                            gov.nasa.jpl.aerie.merlin.framework.ValueMapper.class),
  ...
  private Optional<ComputedAttributesCodeBlocks> getComputedAttributesCodeBlocks(
      final MissionModelRecord missionModel, final ActivityTypeRecord activityType) {
    ...
    if (typeMirror.isPresent()) {
      effectModelReturnMapperBlock =
          new Resolver(this.typeUtils, this.elementUtils, missionModel.typeRules)
    ...
    return Optional.of(
        new ComputedAttributesCodeBlocks(
            computedAttributesTypeName,
            FieldSpec.builder(
                    ParameterizedTypeName.get(
                        ClassName.get(ValueMapper.class), computedAttributesTypeName.box()),
  ...
  public Optional<JavaFile> generateActivityMapper(
      final MissionModelRecord missionModel, final ActivityTypeRecord activityType) {
    final var computedAttributesCodeBlocks$ =
        this.getComputedAttributesCodeBlocks(missionModel, activityType);
    if (computedAttributesCodeBlocks$.isEmpty()) return Optional.empty();

    final var inputTypeMapper$ =
        generateInputType(missionModel, activityType.inputType(), "InputMapper");
    ...
    final var typeSpec =
        TypeSpec.classBuilder(activityType.inputType().mapper().name)
            // The location of the missionModel package determines where to put this class.
            .addOriginatingElement(missionModel.$package)
            // The fields and methods of the activity determines the overall behavior of this class.
            ...
            .addType(
                TypeSpec.classBuilder("OutputMapper")
                    .addSuperinterface(
                        ParameterizedTypeName.get(
            ...
            .addField(
                FieldSpec.builder(
                        ParameterizedTypeName.get(
                            ClassName.get(Topic.class), activityType.getOutputTypeName()),
                        "outputTopic",
                        Modifier.PRIVATE,
                        Modifier.FINAL)
                    .initializer("new $T<>()", ClassName.get(Topic.class))
            ...
            .addMethod(
                MethodSpec.methodBuilder("getInputType")
                    ...
                    .addStatement(
                        "return new $T()",
                        activityType.inputType().mapper().name.nestedClass(inputTypeMapper.name))
                    .build())
            .addMethod(
                MethodSpec.methodBuilder("getOutputType")
                    ...
                    .addStatement(
                        "return new $T()",
                        activityType.inputType().mapper().name.nestedClass("OutputMapper"))
                    .build())
            .addMethod(
                MethodSpec.methodBuilder("getInputTopic")
                    .addModifiers(Modifier.PUBLIC)
                    .addAnnotation(Override.class)
                    .returns(
                        ParameterizedTypeName.get(
                    ...
                    .build())
            .addMethod(
                MethodSpec.methodBuilder("getOutputTopic")
                    .addModifiers(Modifier.PUBLIC)
                    .addAnnotation(Override.class)
                    .returns(
                        ParameterizedTypeName.get(
                    ...
                    .build())
            .addMethod(
                MethodSpec.methodBuilder("getTaskFactory")
                    .addModifiers(Modifier.PUBLIC)
                    .addAnnotation(Override.class)
                    .returns(
                        ParameterizedTypeName.get(
                            ClassName.get(TaskFactory.class), activityType.getOutputTypeName()))
                    .addParameter(
                        ClassName.get(missionModel.topLevelModel), "model", Modifier.FINAL)
                    .addParameter(
                        TypeName.get(activityType.inputType().declaration().asType()),
                        "activity",
                        Modifier.FINAL)
    ...
    return Optional.of(
        JavaFile.builder(activityType.inputType().mapper().name.packageName(), typeSpec)
            .skipJavaLangImports(true)
            .build());
  }
  ...
  private static MethodSpec makeGetReturnValueSchemaMethod() {
    return MethodSpec.methodBuilder("getSchema")
        ...
        .addStatement(
            "return this." + COMPUTED_ATTRIBUTES_VALUE_MAPPER_FIELD_NAME + ".getValueSchema()")
        .build();
  }
  ...
  private Optional<Map<String, CodeBlock>> generateParameterMapperBlocks(
      final MissionModelRecord missionModel, final InputTypeRecord inputType) {
