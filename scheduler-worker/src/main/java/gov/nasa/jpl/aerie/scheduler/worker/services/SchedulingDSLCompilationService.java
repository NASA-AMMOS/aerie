...
public class SchedulingDSLCompilationService {
  ...
  public SchedulingDSLCompilationResult<SchedulingDSL.ConditionSpecifier> compileGlobalSchedulingCondition(final MerlinDatabaseService.ReaderRole merlinService, final PlanId planId, final String conditionTypescript, final
