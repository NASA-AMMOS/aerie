...
public class Duration implements Comparable<Duration>, ConvertableFromString {
    ...
    /**
     * The main constructor everyone should be using - given a duration string, returns an
     * equivalent Duration object
     *
     * @param d A string in format HH:MM:SS.ssssss (though it is pretty forgiving about
     *          not including leading or trailing zeros)
     */
    ...
    /**
     * This is the empty Duration constructor, which will use 0 tics for the input. It is
     * needed when you need to create Duration objects then assign them a value later
    ...
    /**
     * Takes in a Mars duration string of the form ddddMhh:mm:ss.fff or Mhh:mm:ss.fff
     * where dddd is the sol number, hh is the hour, mm is the minutes, and ss.fff is the
     * seconds.
     *
     * @param marsDurString
     * @return
    ...
    /**
     * @return A long, the number of microseconds in the duration. Truncates instead of
     * rounding
     */
    ...
    /**
     * @return A long, the number of milliseconds in the duration. Truncates instead of
     * rounding
     */
     ...
     *
     * @return A float representing the fractional seconds in the span of time. Does not
     * round or truncate
     */
    ...
    /**
     * @return A long, the number of seconds in the duration. Truncates instead of
     * rounding
     */
    ...
    /**
     * @return A long, the number of minutes in the duration. Truncates instead of
     * rounding
     */
     ...
     *
     * @param t2 A time you want to add to
    ...
    /**
     * Multiplies the duration by the input double value. Rounds to the nearest
     * microsecond or double floating point precision, whichever is larger.
     *
     * @param multiplyBy
     * @return A new Duration object
     */
    ...
    /**
     * Divides the duration tics by the input double value and returns a duration. Rounds
     * to the nearest microsecond or double floating point precision, whichever is
     * larger.
     *
     * @param divideBy
     * @return A new Duration object
    ...
    /**
     * Divides the duration tics (floating point division) by the input long value and
     * returns a duration. Rounds to the nearest microsecond or double floating point
    ...
    /**
     * Divides the duration tics (floating point division) by the input int value and
     * returns a duration. Rounds to the nearest microsecond or double floating point
     * precision, whichever is larger.
     *
     * @param divideBy
     ...
     * @return double containing ratio of two Durations
     */
    ...
    /**
     * Returns true if the calling object is less than (closer to negative infinity) the
    ...
    /**
     * Returns true if the calling object is greater than (closer to positive infinity)
    ...
    /**
     * Returns true if the calling object is less than or equal to the parameter, false
     * otherwise
     *
     * @param t2
     * @return a boolean
    ...
    /**
     * Returns true if the calling object is greater than or equal to the parameter, false
     * otherwise
     *
     * @param t2
     * @return a boolean
    ...
    /**
     * Compares the duration to another duration object and returns true if d2 is within
     * an input resolution of d1.
     *
     * @param d2
     * @param resolution
     * @return
    ...
    public static Duration min(Duration... durs) {
        return Collections.min(Arrays.asList(durs));
    }
    ...
    /**
     * Returns a string representing the duration as a mars duration, using the default
     * decimal precision.
     *
     * @return
     */
    ...
    /**
     * Returns string that is the underlying duration formatted according to the format
     * string The format string is defined by the apache commons DurationFormatUtils
     * specification It only returns down to millisecond accuracy, so it cannot be used
     * for fine precision
     *
     * @param format Format string, an example of which would be "d 'days' HH 'hours' mm
     *               'minutes' ss 'seconds and' S 'milliseconds'"
     */
     ...
     * Implements the convertableFromString interface so engines can call valueOf on
     * whatever object including Durations.
     *
     * @param s
     */
    @Override
