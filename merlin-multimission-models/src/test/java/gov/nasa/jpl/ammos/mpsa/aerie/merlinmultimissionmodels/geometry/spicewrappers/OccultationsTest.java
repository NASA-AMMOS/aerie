...
public class OccultationsTest {
    ...
    @Test
    public void testSimpleOccultation() {
        ...
        try {
            List<Pair<Time, Time>> occTimes = Occultations.occultations(frontBody, frontFrame, backBody,
                    backFrame, observer, step, start, end);
