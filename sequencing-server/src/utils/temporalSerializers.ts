...
function isRecord<T>(thing: T | Record<string, any>): thing is Record<string, any> {
  return typeof thing == 'object' && thing !== null && Object.getPrototypeOf(thing) === Object.prototype;
}
...
type SerializedTemporal<T> = T extends Temporal.Instant
  ? { type: 'Temporal.Instant'; value: ReturnType<Temporal.Instant['toString']> }
  : T extends Temporal.ZonedDateTime
  ? { type: 'Temporal.ZonedDateTime'; value: ReturnType<Temporal.ZonedDateTime['toString']> }
  : T extends Temporal.PlainDate
  ? { type: 'Temporal.PlainDate'; value: ReturnType<Temporal.PlainDate['toString']> }
  : T extends Temporal.PlainTime
  ? { type: 'Temporal.PlainTime'; value: ReturnType<Temporal.PlainTime['toString']> }
  : T extends Temporal.PlainDateTime
  ? { type: 'Temporal.PlainDateTime'; value: ReturnType<Temporal.PlainDateTime['toString']> }
  : T extends Temporal.PlainYearMonth
  ? { type: 'Temporal.PlainYearMonth'; value: ReturnType<Temporal.PlainYearMonth['toString']> }
  : T extends Temporal.PlainMonthDay
  ? { type: 'Temporal.PlainMonthDay'; value: ReturnType<Temporal.PlainMonthDay['toString']> }
  : T extends Temporal.Duration
  ? { type: 'Temporal.Duration'; value: ReturnType<Temporal.Duration['toString']> }
  : T extends Temporal.TimeZone
  ? { type: 'Temporal.TimeZone'; value: ReturnType<Temporal.TimeZone['toString']> }
  : T extends Temporal.Calendar
  ? { type: 'Temporal.Calendar'; value: ReturnType<Temporal.Calendar['toString']> }
  : T extends Record<string, any>
  ? { [Property in keyof T]: SerializedTemporal<T[Property]> }
  : T;

type DeserializedTemporal<T> = T extends { type: 'Temporal.Duration'; value: ReturnType<Temporal.Duration['toString']> }
  ? Temporal.Duration
  : T extends { type: 'Temporal.Instant'; value: ReturnType<Temporal.Instant['toString']> }
  ? Temporal.Instant
  : T extends { type: 'Temporal.ZonedDateTime'; value: ReturnType<Temporal.ZonedDateTime['toString']> }
  ? Temporal.ZonedDateTime
  : T extends { type: 'Temporal.Calendar'; value: ReturnType<Temporal.Calendar['toString']> }
  ? Temporal.Calendar
  : T extends { type: 'Temporal.PlainDate'; value: ReturnType<Temporal.PlainDate['toString']> }
  ? Temporal.PlainDate
  : T extends { type: 'Temporal.PlainTime'; value: ReturnType<Temporal.PlainTime['toString']> }
  ? Temporal.PlainTime
  : T extends { type: 'Temporal.PlainDateTime'; value: ReturnType<Temporal.PlainDateTime['toString']> }
  ? Temporal.PlainDateTime
  : T extends { type: 'Temporal.PlainMonthDay'; value: ReturnType<Temporal.PlainMonthDay['toString']> }
  ? Temporal.PlainMonthDay
  : T extends { type: 'Temporal.PlainYearMonth'; value: ReturnType<Temporal.PlainYearMonth['toString']> }
  ? Temporal.PlainYearMonth
  : T extends { type: 'Temporal.TimeZone'; value: ReturnType<Temporal.TimeZone['toString']> }
  ? Temporal.TimeZone
  : T extends Record<string, any>
  ? { [Property in keyof T]: DeserializedTemporal<T[Property]> }
  : T;
