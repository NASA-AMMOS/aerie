...
class BooleansTest {
  @Test
  fun shiftEdgesBasic() {
    val result = gov.nasa.ammos.aerie.procedural.timeline.collections.profiles.Booleans(
  ...
  fun shiftEdgesBoundsShift() {
    val shiftRightResult = gov.nasa.ammos.aerie.procedural.timeline.collections.profiles.Booleans(
    ...
    val shiftLeftResult = gov.nasa.ammos.aerie.procedural.timeline.collections.profiles.Booleans(
