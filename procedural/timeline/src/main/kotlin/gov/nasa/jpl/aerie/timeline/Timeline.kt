...
interface Timeline<V: IntervalLike<V>, THIS: Timeline<V, THIS>> {
   ...
   * [`Intervals<Segment<Boolean>>`][gov.nasa.jpl.aerie.timeline.collections.Intervals] to [Booleans][gov.nasa.jpl.aerie.timeline.collections.profiles.Booleans]
   * without sorting and coalescing the segments could result in an invalid profile. In cases like that, it is better to
   * use [flattenIntoProfile][gov.nasa.jpl.aerie.timeline.ops.ParallelOps.flattenIntoProfile] or [reduceIntoProfile][gov.nasa.jpl.aerie.timeline.ops.ParallelOps.reduceIntoProfile].
   */
   ...
   * because the [gov.nasa.jpl.aerie.timeline.ops.GeneralOps.unsafeOperate] function accesses this for them.
   *
   * @suppress
   */
