...
import gov.nasa.ammos.aerie.timeline.ops.numeric.LinearOps
    ...
    LinearOps<Real>
{
  ...
  /***/ companion object {
    /**
     * Converts a list of serialized value segments into a real profile; for use with [gov.nasa.ammos.aerie.timeline.plan.Plan.resource].
     *
