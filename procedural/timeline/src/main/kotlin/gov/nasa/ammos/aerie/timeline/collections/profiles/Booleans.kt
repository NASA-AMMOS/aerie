...
import gov.nasa.ammos.aerie.timeline.util.duration.unaryMinus
import gov.nasa.ammos.aerie.timeline.ops.BooleanOps
    ...
    BooleanOps<Booleans>
{
  ...
  constructor(segments: List<Segment<Boolean>>): this(
      gov.nasa.ammos.aerie.timeline.BaseTimeline(
          ::Booleans,
          preprocessList(segments, Segment<Boolean>::valueEquals)
      )
  )
   ...
   *
   * @see gov.nasa.ammos.aerie.timeline.ops.numeric.SerialNumericOps.integrate for further explanation of [unit].
   */
  ...
  /***/ companion object {
     ...
     * for use with [gov.nasa.ammos.aerie.timeline.plan.Plan.resource].
     */
