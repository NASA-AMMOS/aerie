...
import gov.nasa.ammos.aerie.timeline.ops.numeric.PrimitiveNumberOps
import gov.nasa.ammos.aerie.timeline.ops.numeric.SerialNumericOps
    ...
    SerialConstantOps<N, Numbers<N>>
{
  ...
  constructor(segments: List<Segment<N>>): this(
      gov.nasa.ammos.aerie.timeline.BaseTimeline(
          ::Numbers,
          preprocessList(segments, Segment<N>::valueEquals)
      )
  )
