...
public class AutoValueMappers {
  ...
  static JavaFile generateAutoValueMappers(final ClassName typeName, final Iterable<? extends Element> recordTypes, final Iterable<? extends Element> annotationTypes) {
    final var builder =
        TypeSpec
  ...
  public static String getIdentifier(String str) {
    if (str.isEmpty()) throw new IllegalArgumentException("Cannot turn empty string into an identifier");
