...
@Component({
  ...
  selector: 'sub-activity-tree',
  styleUrls: ['./sub-activity-tree.component.css'],
  templateUrl: './sub-activity-tree.component.html',
})
export class SubActivityTreeComponent implements OnChanges {
