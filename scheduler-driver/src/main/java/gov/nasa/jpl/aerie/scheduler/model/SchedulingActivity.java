...
public record SchedulingActivity(
  ...
  public static SchedulingActivity of(ActivityType type, SchedulingActivityDirectiveId anchorId, boolean anchoredToStart) {
    return new SchedulingActivity(new SchedulingActivityDirectiveId(uniqueId.getAndIncrement()), type,
                                  Duration.ZERO,
                                  Duration.ZERO,
                                  Map.of(), null,
   ...
   */
  public static SchedulingActivity of(ActivityType type, Duration startOffset, SchedulingActivityDirectiveId anchorId, boolean anchoredToStart) {
    return new SchedulingActivity(new SchedulingActivityDirectiveId(uniqueId.getAndIncrement()), type,
                                  startOffset,
                                  Duration.ZERO,
                                  Map.of(), null,
   ...
   */
  public static SchedulingActivity of(ActivityType type, Duration startOffset, Duration duration, SchedulingActivityDirectiveId anchorId, boolean anchoredToStart) {
    return new SchedulingActivity(new SchedulingActivityDirectiveId(uniqueId.getAndIncrement()), type,
                                  startOffset,
                                  duration,
  ...
  public static SchedulingActivity of(SchedulingActivityDirectiveId id, ActivityType type, Duration startOffset, Duration duration, SchedulingActivityDirectiveId anchorId, boolean anchoredToStart) {
  ...
  public static SchedulingActivity of(ActivityType type, Duration startOffset, Duration duration, Map<String, SerializedValue> parameters, SchedulingActivityDirectiveId anchorId, boolean anchoredToStart) {
    return new SchedulingActivity(new SchedulingActivityDirectiveId(uniqueId.getAndIncrement()), type,
                                  startOffset,
                                  duration,
  ...
  public static SchedulingActivity of(ActivityType type, Duration startOffset, Duration duration, Map<String, SerializedValue> parameters, SchedulingActivityDirectiveId topParent, SchedulingActivityDirectiveId anchorId, boolean anchoredToStart) {
    return new SchedulingActivity(new SchedulingActivityDirectiveId(uniqueId.getAndIncrement()), type,
                                  startOffset,
                                  duration,
  ...
  public static SchedulingActivity copyOf(SchedulingActivity activityInstance, Duration duration){
  ...
  public static SchedulingActivity copyOf(SchedulingActivity activityInstance, SchedulingActivityDirectiveId anchorId, boolean anchoredToStart, Duration startOffset){
    return SchedulingActivity.of(
        activityInstance.id,
        activityInstance.type,
        startOffset,
   ...
   */
  public static SchedulingActivity fromActivityDirective(ActivityDirectiveId id, ActivityDirective activity, ActivityType type, Duration duration){
    return SchedulingActivity.of(
   ...
   */
  public static SchedulingActivity of(SchedulingActivity o) {
    return new SchedulingActivity(
