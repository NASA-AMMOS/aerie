...
public class Procedure extends Goal {
  private final gov.nasa.jpl.aerie.merlin.protocol.scheduling.Procedure procedure;

  public Procedure(gov.nasa.jpl.aerie.merlin.protocol.scheduling.Procedure procedure) {
