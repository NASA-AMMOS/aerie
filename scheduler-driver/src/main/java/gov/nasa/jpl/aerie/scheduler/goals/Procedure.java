...
public class Procedure extends Goal {
  ...
  public void run(Evaluation eval, Plan plan, Function<String, ActivityType> lookupActivityType, SimulationFacade simulationFacade, DirectiveIdGenerator idGenerator) {
