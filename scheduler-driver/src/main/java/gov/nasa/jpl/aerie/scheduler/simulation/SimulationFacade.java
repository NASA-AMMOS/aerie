...
public interface SimulationFacade {
  ...
  CheckpointSimulationDriver.SimulationResultsComputerInputs simulateNoResultsUntilEndPlan(Plan plan)
  throws SimulationException, SchedulingInterruptedException;

  CheckpointSimulationDriver.SimulationResultsComputerInputs simulateNoResultsUntilEndAct(
      Plan plan,
