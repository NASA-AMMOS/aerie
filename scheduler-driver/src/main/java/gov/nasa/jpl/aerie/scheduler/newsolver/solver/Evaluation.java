...
public class Evaluation {
  ...
  public static class GoalEvaluation {
     ...
     */
    protected final Map<SchedulingActivityDirective, Boolean> acts = new java.util.HashMap<>();
    ...
    public java.util.Collection<SchedulingActivityDirective> getAssociatedActivities() {
      return Collections.unmodifiableSet(acts.keySet());
    }
    /**
    ...
    public java.util.Collection<SchedulingActivityDirective> getInsertedActivities() {
      return Collections.unmodifiableSet(acts.entrySet().stream().filter((a)-> a.getValue().equals(true)).map(
   ...
   */
  public Map<Goal,GoalEvaluation> getGoalEvaluations() { return Collections.unmodifiableMap(goalEvals); }
