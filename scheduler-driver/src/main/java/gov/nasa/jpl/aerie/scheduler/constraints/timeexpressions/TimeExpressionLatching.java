...
public class TimeExpressionLatching extends TimeExpression {
  public TimeExpressionLatching(
      final TimeExpression expr1, final TimeExpression expr2, final TimeRangeExpression expr) {
    this.expr1 = expr1;
    this.expr2 = expr2;
  ...
  public Interval computeTime(
    ...
    List<Interval> resetPeriods =
        StreamSupport.stream(
                resetWindowsExpression
                    .computeRange(simulationResults, plan, new Windows(true))
                    .iterateEqualTo(true)
                    .spliterator(),
                false)
            .toList();
