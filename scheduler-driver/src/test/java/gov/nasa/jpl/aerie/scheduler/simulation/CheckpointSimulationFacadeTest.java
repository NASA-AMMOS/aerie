...
public class CheckpointSimulationFacadeTest {
  ...
  private static PlanInMemory makePlanA012(Map<String, ActivityType> activityTypeMap) {
    ...
    plan.add(SchedulingActivity.of(actTypeA, t0, null, null, true));
    plan.add(SchedulingActivity.of(actTypeA, t1hr, null, null, true));
    plan.add(SchedulingActivity.of(actTypeA, t2hr, null, null, true));
    return plan;
  }
  @BeforeEach
  public void before(){
  ...
  throws SchedulingInterruptedException, SimulationFacade.SimulationException
  {
    ...
    plan.add(SchedulingActivity.of(actTypeA, t0, HOUR.times(200), null, true));
