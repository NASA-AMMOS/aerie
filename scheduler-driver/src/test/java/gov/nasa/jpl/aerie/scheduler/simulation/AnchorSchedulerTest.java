...
public class AnchorSchedulerTest {
  ...
  public final class AnchorsSimulationDriverTests {
    ...
    private void constructFullComplete5AryTree(int maxLevel, int currentLevel, long parentNode, Map<ActivityDirectiveId, ActivityDirective> activitiesToSimulate, Map<SimulatedActivityId, ActivityInstance> simulatedActivities){
    ...
    public void activitiesAnchoredToPlan() throws SchedulingInterruptedException {
      ...
      final Map<SimulatedActivityId, ActivityInstance> simulatedActivities = new HashMap<>(415);
      ...
      for (long l = 0; l < 5; l++) {
        ...
        simulatedActivities.put(new SimulatedActivityId(l), new ActivityInstance(
            serializedDelayDirective.getTypeName(),
            Map.of(),
      ...
      simulatedActivities.put(new SimulatedActivityId(15), new ActivityInstance(
          serializedDelayDirective.getTypeName(),
          Map.of(),
          Instant.EPOCH,
          oneMinute,
    ...
    public void activitiesAnchoredToOtherActivities() throws SchedulingInterruptedException {
      ...
      final Map<SimulatedActivityId, ActivityInstance> simulatedActivities = new HashMap<>(800);
    ...
    public void decomposingActivitiesAndAnchors() throws SchedulingInterruptedException {
      ...
      topLevelSimulatedActivities.put(
          ...
          new ActivityInstance(serializedDecompositionDirective.getTypeName(), Map.of(), Instant.EPOCH, threeMinutes, null, List.of(), Optional.of(new ActivityDirectiveId(2)), computedAttributes));
      topLevelSimulatedActivities.put(
      ...
      final var childSimulatedActivities = new HashMap<SimulatedActivityId, ActivityInstance>(28);
      final var otherSimulatedActivities = new HashMap<SimulatedActivityId, ActivityInstance>(23);
    ...
    public void naryTreeAnchorChain() throws SchedulingInterruptedException {
      ...
      final var simulatedActivities = new HashMap<SimulatedActivityId, ActivityInstance>(3906);
