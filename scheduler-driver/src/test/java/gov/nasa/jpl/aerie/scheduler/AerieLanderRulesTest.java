...
//  @BeforeEach
//  void setUp(){
//    planningHorizon = new PlanningHorizon(TestUtility.timeFromEpochSeconds(0),
// TestUtility.timeFromEpochSeconds(48 * 3600));
...
//    rules = new AerieLanderRules(aerieLanderMissionModel, planningHorizon,
// aerieLanderSchedulerModel);
//    plan = makeEmptyPlan();
//    smallProblem = new Problem(aerieLanderMissionModel, planningHorizon,
// rules.getSimulationFacade(), aerieLanderSchedulerModel);
//  }
//
...
//    final var activityInstancePresent = new ActivityInstance(rules.getActivityType("IDAMoveArm"),
// planningHorizon.fromStart("P1D"), Duration.of(20, Duration.MINUTE), null, true);
//    plan.add(activityInstancePresent);
//    schedule(true);
//    //assert than the procedural goal has a score equal to 0, that the association has been
// performed
...
//    assertTrue(TestUtility.activityStartingAtTime(plan, time,
// rules.getActivityType("SSAMonitoring")));
//    assertTrue(TestUtility.activityStartingAtTime(plan, time,
// rules.getActivityType("HeatProbeTemP")));
//    for(var t = Duration.HOUR; t.shorterThan(planningHorizon.getEndAerie()); t =
// t.plus(Duration.HOUR)){
//      assertTrue(TestUtility.activityStartingAtTime(plan, time,
// rules.getActivityType("HeatProbeTemP")));
//    }
//  }
...
//    schedule(false);
//    assertTrue(TestUtility.containsActivity(plan, planningHorizon.fromStart("P1D"),
//                                        planningHorizon.fromStart("P1DT8H"),
// rules.getActivityType("AllocateDSNStation")));
//    assertTrue(TestUtility.containsActivity(plan, planningHorizon.fromStart("P1D"),
//                                        planningHorizon.fromStart("P1DT5M23S"),
// rules.getActivityType("XBandPrep")));
//    assertTrue(TestUtility.containsActivity(plan, planningHorizon.fromStart("P1D"),
//                                        planningHorizon.fromStart("P1DT8H"),
// rules.getActivityType("XBandCommSched")));
//    assertTrue(TestUtility.containsActivity(plan, planningHorizon.fromStart("P1DT5M23S"),
//                                        planningHorizon.fromStart("P1DT7H59M41S"),
// rules.getActivityType("XBandActive")));
//    assertTrue(TestUtility.containsActivity(plan, planningHorizon.fromStart("P1DT7H59M41S"),
//                                        planningHorizon.fromStart("P1DT8H"),
// rules.getActivityType("XBandCleanup")));
//  }
// }
