...
public class NexusMetaSolverTest {
  ...
  private static PlanInMemory makePlanA012(Problem problem) {
    ...
    plan.add(SchedulingActivity.of(actTypeA, t0, d1min, null, true));
    plan.add(SchedulingActivity.of(actTypeA, t1hr, d1min, null, true));
    plan.add(SchedulingActivity.of(actTypeA, t2hr, d1min, null, true));
    return plan;
  }
  ...
  private static PlanInMemory makePlanAB012(Problem problem) {
    ...
    plan.add(SchedulingActivity.of(actTypeB, t0, d1min, null, true));
    plan.add(SchedulingActivity.of(actTypeB, t1hr, d1min, null, true));
    plan.add(SchedulingActivity.of(actTypeB, t2hr, d1min, null, true));
    return plan;
  }
